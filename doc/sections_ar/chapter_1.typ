...
#ar_std([
  ...
  + تدريب وتعديل نموذج #en_clean_std([ASR]) المحدد لتحسين أدائه ودقته بشكل خاص لنسخ أوامر #en_clean_std([Linux shell]).
