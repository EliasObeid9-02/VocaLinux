...
=== #en([Standard Data Splits])
  ...
  #figure(
    table(
      ...
      [`train-clean-100`], [$100$], [$251$], [Clean audio samples for short training.],
      [`train-clean-360`], [$360$], [$921$], [Clean audio samples for long training.],
      [`train-other-500`], [$500$], [$1166$], [Challenging audio samples for training.],
      [`dev-clean`], [$5.4$], [$40$], [Clean audio samples for validation/development.],
      [`dev-other`], [$5.1$], [$39$], [Challenging audio samples for validation/development.],
      [`test-clean`], [$5.4$], [$40$], [Clean audio samples for final evaluation.],
      [`test-other`], [$5.1$], [$40$], [Challenging audio samples for final evaluation.],
    ),
...
=== #en([Inference Strategy: Language Model Integration])
  ...
  - *Dictionary Correcting*: One might use a dictionary to limit the search space to only valid words, correcting spelling errors. However, the LAS paper authors found this to have no impact on WER, as their model learned to spell correctly on its own.
